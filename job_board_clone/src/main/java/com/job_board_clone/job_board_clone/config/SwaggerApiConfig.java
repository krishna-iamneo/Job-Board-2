...
public class SwaggerApiConfig {
    public static final String SWAGGER_INFO_TITLE = "Job Board API";
    public static final String SWAGGER_INFO_DESCRIPTION = "This is Job Board API documentation";
    public static final String SWAGGER_INFO_VERSION = "1.0.0";
    public static final String SWAGGER_INFO_CONTACT_NAME = "Iamneo";
    public static final String SWAGGER_INFO_CONTACT_EMAIL = "shivam.pandey@iamneo.ai";
